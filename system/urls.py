...
urlpatterns = [
    ...
    # path("club/<int:club_id>/members/", views.members_list_name_ascending, name='members_list_name_ascending'),
    # path("club/<int:club_id>/members/", views.members_list_name_descending, name='members_list_name_descending'),
