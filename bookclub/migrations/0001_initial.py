# Generated by Django 3.2.5 on 2022-02-18 20:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chooser', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='rotations', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_action', models.CharField(choices=[('B', 'Book'), ('C', 'Club'), ('M', 'Meeting'), ('R', 'Rating')], max_length=1)),
